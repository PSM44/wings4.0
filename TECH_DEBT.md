...
| TD-015 | Portfolio data | Capability and relationship maps remain placeholders. | Ownership and dependencies are not operational. | PARTIALLY_RESOLVED_FIRST_PILOT_ENTRIES_2026-07-30 | GOV-005, PILOT-001, PILOT-002 |
| TD-016 | Governance validation | The active-project governance cycle has not been proven end-to-end. | Wings4.0 remains conceptually strong but operationally unvalidated. | PARTIALLY_VALIDATED_2026-07-30 (assimilation and pairwise-review steps proven on Brainy/SkillsMachine; intervention delivery and resynchronization steps remain blocked on human approval, see PILOT-003/004 in MIGRATION.BACKLOG.md) | PILOT-001 to PILOT-004 |
...
| TD-018 | HUMAN heterogeneity | Project HUMAN files vary in structure, completeness, and freshness. | Cross-project comparison may produce low-confidence conclusions. | CONFIRMED_WITH_EVIDENCE_2026-07-30 (Brainy uses structured, dated, numbered Markdown; SkillsMachine uses terse KEY=VALUE `.txt`; both usable, but comparison required manual normalization — see `PORTFOLIO.REVIEWS/PAIRWISE.BRAINY_VS_SKILLSMACHINE.md`) | GOV-004, GOV-005 |
| TD-019 | Open-source review | No real build-versus-adopt review has been executed. | Project retirement recommendations remain untested. | IDENTIFIED_NOT_ADDRESSED_BY_PILOT-001..004 (out of scope: PILOT-001/002 assimilated and compared two active projects; no build-versus-adopt/external-solution review was in scope of this cycle) | GOV-006, PILOT-002 |
